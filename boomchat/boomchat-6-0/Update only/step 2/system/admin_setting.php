...
*/
$load_setting = '*';
$load_user = 'user_rank, user_name, user_theme';
...
?>
			<div class="bottom_separator" id="top_setting_option">
				<button class="setting_option_button sub_button selected_element button_left" value="setting_site"><?php echo $section_site; ?></button>
				<button class="setting_option_button sub_button button_right" value="setting_account"><?php echo $section_account; ?></button>
				<button class="setting_option_button sub_button button_left" value="setting_chat"><?php echo $section_chat; ?></button>
				<button class="setting_option_button sub_button button_right" value="setting_upload"><?php echo $section_upload; ?></button>
				<button class="setting_option_button sub_button button_left" value="setting_limit"><?php echo $section_limit; ?></button>
				<button class="setting_option_button sub_button button_right" value="setting_user"><?php echo $section_users; ?></button>
				<button class="setting_option_button sub_button button_left" value="setting_ads"><?php echo $section_ads; ?></button>
				<button class="setting_option_button sub_button button_right" value="setting_advance"><?php echo $section_advance; ?></button>
				<div class="clear"></div>
			</div>
			<div class="top_separator" id="container_setting">
				...
				<div class="setting_part" id="setting_user">
					...
					<p class="sub_color">Note: Changing name of custom field will erase old field data</p>
				</div>
				...
				<button id="setting_button"  class="sub_button hover_element" type="button"><?php echo $lang_upset; ?></button> 
			</div>