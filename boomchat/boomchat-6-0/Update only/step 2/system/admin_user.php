...
?>
			<div class="bottom_separator" id="top_setting_option">
				<button class="view_user_button sub_button  button_left" value="view_admin"><?php echo $rkadmin; ?></button>
				<button class="view_user_button sub_button button_right" value="view_modo"><?php echo $rkmodo; ?></button>
				<button class="view_user_button sub_button button_left" value="view_muted"><?php echo $rkmuted; ?></button>
				<button class="view_user_button sub_button button_right" value="view_banned"><?php echo $rkbanned; ?></button>
				<button class="view_user_button sub_button button_left" value="view_vip"><?php echo $rkvip; ?></button>
				<div class="clear"></div>
			</div>
<?php
