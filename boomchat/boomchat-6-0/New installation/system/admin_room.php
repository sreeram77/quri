...
if($user['user_rank'] < 4){
	...
	<div id=\"room_all\" class=\"top_separator\">
		<div id=\"top_setting_option\">
			<button id=\"access1\" class=\"room_select_button sub_button button_left\" value=\"access1\">$opublic $oroom</button>
			<button id=\"access2\" class=\"room_select_button sub_button button_right\" value=\"access2\">$ovip $oroom</button>
			<button id=\"access3\" class=\"room_select_button sub_button button_left\" value=\"access3\">$ostaff $oroom</button>
			<button id=\"access4\" class=\"room_select_button sub_button button_right\" value=\"access4\">$oadmin $oroom</button>
			<div class=\"clear\"></div>
		</div>";
