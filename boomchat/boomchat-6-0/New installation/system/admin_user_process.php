...
if (isset($_POST['delete_modo']) && $user['user_rank'] > 3){
...
elseif (isset($_POST['delete_admin']) && $user['user_rank'] > 4){
...
// demote admin and rerank to user status
elseif (isset($_POST['delete_vip']) && $user['user_rank'] > 4){
...
elseif (isset($_POST['delete_banned']) && $user['user_rank'] > 3){
...
elseif (isset($_POST['delete_muted']) && $user['user_rank'] > 2){
