...
*/
$load_setting = 'timezone, allow_theme, default_theme, language, min_age, custom_count, custom1, custom2';
$load_user = 'user_name, user_theme, user_email, user_age, user_sex, user_description, user_sound, country, region, last_action, custom1, custom2';
