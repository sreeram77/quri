...
<div class="panels top_panels panelone"  id="tools_panel">
	...
	<div class="panel_element top_separator">
		<div id="profile_menu">
				<button class="profile_button sub_button button_left selected_element" value="profile_personal"><?php echo $btn_personal; ?></button>
				<button class="profile_button sub_button button_right" value="profile_data"><?php echo $btn_logpass; ?></button>
				<button class="profile_button profile_button_full sub_button button_right" value="profile_social"><?php echo $btn_social; ?></button>
				<div class="clear"></div>
		</div> 
		<div class="profile_info">
			...
			<div id="profile_personal" class="profile_zone">
				...
				<button class="sub_button hover_element" id="account_button"><?php echo $upupdate; ?></button><br /><br />
			</div>
				...
				<div class="profile_section" id="my_profile_password">
					<div class="details change_password">
						...
						echo '<div class="profile_error"><div id="error_info"></div></div>
							...
							<button class="sub_button hover_element"  id="update_name">' . $update_name . '</button><br/>';
						}
						?>
						...
						<button class="sub_button hover_element"  id="update_email"><?php echo $update_email; ?></button><br/>
						
						
						
						
						<div class="profile_error"><div id="error_info3"></div></div>
			...
			<div id="profile_social" class="profile_zone">
				...
				<p id="social_error"></p>
				<button class="sub_button hover_element"  id="update_social"><?php echo $upupdate; ?></button>
			</div>
		</div>
	</div>
