		<div id="container_help">
			...
			?>
			<?php if ($user['user_rank'] > 3){
					echo "<div value=\"/clear all\" class=\"wrap_command sub_element hover_element\"><div class=\"command_copy \"><p class=\"sub_color\">/clear all</p></div><div class=\"effect\"><p>$dclearall<br />$example /clear all</p></div><div class=\"clear\"></div></div>
					<div value=\"/rename\" class=\"wrap_command sub_element hover_element\"><div class=\"command_copy \"><p class=\"sub_color\">/rename</p></div><div class=\"effect\"><p>$drename<br />$example /rename $hroom</p></div><div class=\"clear\"></div></div>";
					}
			?>
			<?php if ($user['user_rank'] >= $setting['allow_private'] && $user['guest'] !== 1){
