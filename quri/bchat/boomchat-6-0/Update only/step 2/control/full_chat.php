	...
	<?php include('ignore_panel.php'); ?>
	<?php include('profile_panel.php'); ?>
	<?php include('option_panel.php'); ?>
	...
	<?php if($user['user_rank'] >= $setting['allow_image'] && $user['upload_access'] == 1 && $user['guest'] != 1){ include('image_panel.php'); } ?>
