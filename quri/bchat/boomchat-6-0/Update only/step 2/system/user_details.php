...
*/
$load_setting = 'timezone, allow_theme, default_theme, language, allow_avatar, custom_count, custom1, custom2, domain';
...
if(isset($_POST['get_user'])){
	...
	$info = $find_user->fetch_array(MYSQLI_BOTH);
		...
		if($user['user_rank'] > $info['user_rank']){
		...
		<div class="edit_section">
			...
			<div id="avatar" class="avatar_edit">
				<?php echo '<img  id="eavatar" value="' . $setting['domain'] . '/' . $icon_path . '/default_avatar.png" class="profile_avatar"  src="' . $setting['domain'] . '/' . $avatar_path . '/' . $avatar . '"/>'; ?>
			</div>
			<button class="sub_button hover_element edit_button"  value="avatar" id="edit_avatar"><?php echo $remove_avatar; ?></button><br/>
			<div class="clear"></div>
		</div>
		<div class="edit_section">
		<?php
		...
		<div class="edit_section">
			<button class="edit_action_button hover_element sub_button button_left edit_button" value="kick"><?php echo $uskick; ?></button>
			<button class="edit_action_button hover_element sub_button button_right edit_button" value="mute"><?php echo $usmute; ?></button>
			<button class="edit_action_button hover_element sub_button button_left edit_button" value="ban"><?php echo $usban; ?></button>
			<button class="edit_action_button hover_element sub_button button_right edit_button" value="delete"><?php echo $usdelete; ?></button>
			<div class="clear"></div>
		</div>
		<div class="edit_section">
			<p id="error_mname"></p>
			<input placeholder="<?php echo $info['user_name']; ?>" class="input_password background_box" id="new_member_name"/><br/>
			<button class="sub_button hover_element" value="name" id="edit_name"><?php echo $update_name; ?></button><br/>
			<div class="clear"></div>
		</div>
		<div class="edit_section">
			<p id="error_email"></p>
			<input placeholder="<?php echo $info['user_email']; ?>" class="input_password background_box" id="new_email"/><br/>
			<button class="sub_button hover_element" value="email" id="edit_email"><?php echo $update_email; ?></button><br/>
			<div class="clear"></div>
		</div>
		<div class="edit_section">
			<p id="error_pass"></p>
			...
			<button class="sub_button hover_element" value="password" id="edit_password"><?php echo $upchangepass5; ?></button><br/>
			<div class="clear"></div>
		</div>
