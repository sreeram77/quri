$(document).ready(function(){
	...
	$('#chat_panel').on('click', '#edit_password', function(){
	...
	$('#chat_panel').on('click', '#edit_email', function(){
	...
	$('#chat_panel').on('click', '#edit_name', function(){
	...
	$('#chat_panel').on('click', '.edit_button', function(){
